#!/bin/bash
# Script de autenticação OAuth para Google Workspace MCP com acesso completo ao Drive

echo "=========================================="
echo "🔐 Autenticação Google Workspace MCP"
echo "   (com acesso total ao Drive)"
echo "=========================================="
echo ""

# Criar script Python para autenticação
cat > /tmp/auth_google_full.py << 'PYEOF'
#!/usr/bin/env python3
"""
Autenticação OAuth com scope drive.readonly para acessar arquivos compartilhados
"""
...
# Scopes com acesso completo ao Drive (incluindo arquivos compartilhados)
SCOPES = [
    "https://www.googleapis.com/auth/gmail.modify",
    "https://www.googleapis.com/auth/calendar",
    "https://www.googleapis.com/auth/drive.readonly"  # Acesso a todos os arquivos, não só criados pelo app
]
...
def main():
    ...
    print("Com acesso total ao Drive (arquivos compartilhados)")
    print("=" * 50)
    print("")
    ...
    print("")
    print("Aviso: Esta versao requer acesso completo ao Drive")
    print("para ler arquivos compartilhados com voce.")
    print("")
    ...
    print("com acesso a arquivos compartilhados!")
    print("")
...
python3 /tmp/auth_google_full.py

# Limpar
rm -f /tmp/auth_google_full.py
